...
func getConnection() (*mongo.Client, context.Context, context.CancelFunc) {
	//username := os.Getenv("zaid")
	//password := os.Getenv("abc1234")
	//clusterEndpoint := os.Getenv("cluster0.hju5a.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")

	//connectionURI := fmt.Sprintf(connectionStringTemplate, username, password, clusterEndpoint)

	client, err := mongo.NewClient(options.Client().ApplyURI("mongodb+srv://zaid:abc1234@cluster0.hju5a.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"))
	if err != nil {
